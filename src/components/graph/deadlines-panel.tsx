      ...
      <div className="max-h-80 overflow-y-auto p-2">
        {tasksWithDates.length === 0 ? (
          ...
          <>
            {overdue.length > 0 && (
              <div className="mb-2">
                <p className="text-eyebrow px-2 py-1.5 text-[var(--danger)]">
            ...
            {upcoming.length > 0 && (
              <div>
                <p className="text-eyebrow px-2 py-1.5">Upcoming</p>
                {upcoming.map((task) => (
  ...
  return (
    ...
    >
      <div className="min-w-0 flex-1">
        ...
        <p className={`text-[10px] ${isOverdue ? "text-[var(--danger)]" : "text-body"}`}>
